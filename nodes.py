    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "steps": ("INT", {"default": 50, "min": 1, "max": 200, "tooltip": "Number of denoising steps for the initial dense stage"}),
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "mode_1024": (["refine", "full", "skip"], {"default": "refine", "tooltip": "1024 refinement mode. 'refine' is recommended for 16GB VRAM"}),
