...
from ..attention import SparseMultiHeadAttention, SerializeMode, SpatialSparseAttention,SparseProjAttention
...
class ModulatedSparseTransformerCrossBlock(nn.Module):
    ...
    def __init__(
        ...
        if self.image_attn_mode == 'cross':
            ...
            self.cross_attn = SparseProjAttention(cross_attn_block=cross_attn)
        self.mlp = SparseFeedForwardNet(
            channels,
            mlp_ratio=mlp_ratio,
        )
